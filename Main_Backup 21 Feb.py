...
class ToughenedPartition:
    ...
    def variables(self):
        ...
        nextButt=tk.Button(self.frame1, text = 'Next', font=("",10,"bold"), width=17, command = obj.costPage)
        nextButt.grid(column=1,row=18, padx=10, pady=15, sticky='W')
...
class CompositePanel:
    ...
    def variables(self):
        ...
        compShe = ttk.Combobox(self.frame1, textvariable=fraColVar, width=30, values=composite_options )
