...
aluminium_material = ["Regular Section", "Domal Section", "UPVC Section", "Profile Aluminium Section"]
glass_thickness = ["3.5mm", "4mm", "5mm", "8mm", "12mm"]
glass_type = ["Plain", "Frosted", "One-way", "Tinted", "Bajra"]
hardware_lock = ["3/4th inch", "1 inch","Domal full metal body"]
hardware_bear = ["3/4th inch", "1 inch", "Domal teflon bearing"] 
rubber_type = ["Clear", "Jumbo", "Powder" "Jumbo"]
rubber_thick = ["4mm", "5mm"]
aluminium_net = ["3ft bundle" ,"4ft bundle","5ft bundle","14 x 14 Aluminium net", "Fiber Net"]
